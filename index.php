	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<div class="login-header">
				<div class="brand">
					<span class="logo"></span> <b>Acceso</b> Admin
					<small>Si eres administrador ingresa aqui</small>
				</div>
				<div class="icon">
			   ...
			   <span class="close" data-dismiss="alert">x</span>
				  <strong>Error: </strong>Campos Vacios</a>
					...
					<div class="form-group m-b-20">
						<input type="text"  name="usu_correo" id="usu_correo"  class="form-control form-control-lg" placeholder="Correo Electronico" required="">
					</div>
					<div class="form-group m-b-20">
